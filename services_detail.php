                ...
                <div class="row">
                    ...
                    <section class="services-details">
                                ...
                                <div class="col-12 wow fadeInUp animated" data-wow-delay="400ms">
                                    <div class="services-details__content">
                                        ...
                                        <div class="services-details__thumb">
                                            <img src="<?= show_thumb(UP_FILES_WS_PATH . '/services/' . $line_raw['s_image'], 970, 381, 'resize') ?>"
                                                width="100%" />
                                        </div>
                                        <?php } ?>
                                        <h3 class="services-details__content__title"> <?= ($line_raw['s_title']); ?>
                                        </h3>
                                        <style>
                                        p img {
                                        ...
                                        <p class="services-details__content__text"> <?= ($line_raw['s_description']); ?>
                                        </p>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card shadow-lg border-0 rounded-4 hover-zoom h-100">
                                                    <div class="card-body p-4">
                                                        <h3
                                                            class="services-details__content__title text-primary fw-bold">
                                                            📄 Document</h3>
                                                        <hr class="mb-3">
                                                        <h4 class="services-details__content__title">
                                                            <strong>Title:</strong>
                                                            <span
                                                                class="card-text badge bg-warning text-dark px-2 py-1 rounded-pill">
                                ...
                                ?>
                                                        <div class="file-preview-container text-center">
                                                            <div class="file-preview-card shadow-lg rounded-3 p-3">
                                                                <h6 class="text-secondary mb-2">Format:
                                                                    <strong><?= $file_format; ?></strong>
                                                                </h6>
                                                                <!-- <?php if (in_array($file_extension, ['jpg', 'jpeg', 'png', 'gif'])) { ?>
                                        <img src="<?= $file_path; ?>" class="img-fluid rounded"
                                          alt="Document Image">
                                      <?php } elseif ($file_extension === 'pdf') { ?>
                                        <iframe src="<?= $file_path; ?>"
                                          class="pdf-preview w-100" frameborder="0"></iframe>
                                      <?php } else { ?>
                                        <div class="file-icon">
                                      ...
                                      <?php } ?> -->
                                                                <div class="mt-3">
                                                                    <a href="<?= $file_path; ?>" target="_blank"
                                                                        class="btn btn-outline-success fw-bold me-2">
                                                                        👁️ View File
                                                                    </a>
                      ...
                      ?>
                                        ...
                                        <div class="accrodion-one__wrapper nisoz-accrodion"
