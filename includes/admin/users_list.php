                ...
                <tr>
                  <td width="75%"  ><table width="100%"  border="0" align="center" cellpadding="2" cellspacing="0" class="tableSearch">
                      ...
                      <tr>
                        ...
                        <td width="178"><input name="u_username" type="text" value="<?=$u_username?>" /></td>
                        <td align="right">City :</td>
                        <td width="143"><input name="u_city" type="text" value="<?=$u_city?>" /></td>
                        <td width="258"><input name="export4" type="checkbox" id="export4" value="1" />
				    ...
				    <th width="6%" nowrap="nowrap">Direct</th>
					  <th width="6%" nowrap="nowrap">Max Topup</th>
					    <!--<th width="6%" nowrap="nowrap">Income Balance</th>-->
						  <th width="6%" nowrap="nowrap">E-Wallet Balance</th>
...
?>
                <tr class="<?=$css?>">
                  ...
                  <td nowrap="nowrap"><?=$u_state?> </td>

                  <td nowrap="nowrap"><?=db_scalar("select   u_username  from ngo_users where u_id = '$u_ref_userid'");?></td>
                ...
                <tr>
                  <td align="right" valign="top" style="padding:2px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<td width="16%" align="left" valign="top" style="padding:2px">Date Of Join<br />
 					 ...
 					 <!--  <input name="u_bank_lock" type="text" value="<?=$u_bank_lock?>" size="20" />-->
