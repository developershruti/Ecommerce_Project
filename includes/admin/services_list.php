                    ...
                    <form method="get" name="form2" id="form2" onSubmit="return confirm_submit(this)">
                      <table class="table table-bordered">
                        <tr>
                          ...
                          <td><input name="s_title" class="form-control" type="text" value="<?= htmlspecialchars($s_title) ?>" /></td>
                          <td class="tdLabel" align="right" nowrap="nowrap">Status :</td>
                          <td class="tdLabel" align="right" nowrap="nowrap"><?= service_status_dropdown('s_status', $s_status) ?></td>
                          <td align="right">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 ">
                          <div class="grid-container lh-25">
                            <a class="btn btn-primary float-right" href="services_f.php">Add Services</a>
                          </div>
                        </div>
                      </div>
                    </div>
                          ...
                          ?>
                            <tr class="<?= $css ?>">
                              <td nowrap="nowrap"><?= $s_id ?></td>
									<td nowrap="nowrap"><?=$page_cate_name = db_scalar("select scate_name from ngo_service_cate where scate_id='$line[s_scate_id]' ") ?></td>
                              <td><?= $s_title ?></td>

                              <td nowrap="nowrap"><? if($s_image!=''){ ?>

                                <img src="<?= UP_FILES_WS_PATH . '/services/' . $s_image ?>" width="98" /> <? } ?> 
                              ...
                              <td>
                                ...
                                <?php if ($s_status == 'Active') { ?>
                                  <button type="button" class="btn btn-success btn-sm waves-effect waves-light"><?= $s_status ?></button>
                                <?php } else if ($s_status == 'Inactive') { ?>
                                  <button type="button" class="btn btn-danger btn-sm waves-effect waves-light"><?= $s_status ?></button>
                                <?php } ?>

                              </td>

                              <td align="center" nowrap="nowrap"><a href="services_f.php?s_id=<?=$s_id?>"><img src="images/icons/edit.png" alt="Edit" width="16" height="16" border="0" /></a> |
                               <a href="faq_list.php?faq_s_id=<?=$s_id?>"><i class="mdi mdi-comment-question-outline font-size-15"></i></a> |
                               <a href="document_list.php?document_s_id=<?=$s_id?>"><i class="mdi mdi-file-document-outline font-size-15"></i></a>

                              </td>
                              <td align="center"><input name="arr_s_ids[]" type="checkbox" id="arr_s_ids[]" value="<?= $s_id ?>" /></td>
                            </tr>
                          <? }
                          ?>
                        </table>
                        <table width="100%">
                          <tr>
                            ...
                            <td width="25%" align="right" style="padding:2px">
                              ...
                              <input name="Activate" type="image" src="images/buttons/activate.gif" onClick="return activateConfirmFromUser('arr_s_ids[]')" />
                              <input name="Deactivate" type="image" src="images/buttons/deactivate.gif" onClick="return deactivateConfirmFromUser('arr_s_ids[]')" />
                            </td>
