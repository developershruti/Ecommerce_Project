...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="content">
      ...
      <br />
          <!--  <div align="right"> <a href="complain_f.php">Add New
         Complain      </a></div>-->
          ...
          <tr>
            ...
            <th width="16%" align="center" nowrap="NOWRAP">Complain by User ID
             ...
             <th width="13%" align="center" nowrap="NOWRAP">Complain by Name
               <?= sort_arrows('u_fname')?></th>  <th width="16%" align="center" nowrap="NOWRAP">Mobile</th>
            <th width="39%" align="left" nowrap="NOWRAP">Title <?= sort_arrows('comp_title')?></th>
                      
            <th width="13%" align="center" nowrap="NOWRAP">Complain </th>
            <th width="13%" align="center" nowrap="NOWRAP">Status <?= sort_arrows('comp_status')?></th>
...
?>
          <tr class="<?=$css?>">
            ...
            <td nowrap="nowrap"><?=$u_username?></td><td nowrap="nowrap"><?=$u_fname?></td>
                       <td nowrap="nowrap"><?=$u_mobile?></td>
                        ...
                        <td nowrap="nowrap"><?=$comp_status?></td>
                                    ...
                                    <td align="center" nowrap="nowrap"><a href="complain_details.php?comp_id=<?=$comp_id?>">Complain Details(<?=$new_complain?>)</a> </td>
