                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table table-bordered mb-0">
                          ...
                          ?>
                            <tr class="<?= $css ?>">
                              ...
                              <td nowrap="nowrap">
                                <? if ($slider_image != '') { ?>
                                  <img src="<?= UP_FILES_WS_PATH . '/slider/' . $slider_image ?>" width="98" /> <? } ?>
                              </td>
                        ...
                        <table width="100%">
                          <tr>
                            ...
                            <td width="25%" align="right" style="padding:2px">
                              ...
                              <input name="Delete" type="image" id="Delete" src="images/buttons/delete.gif" onClick="return deleteConfirmFromUser('arr_slider_ids[]')" />
                            </td>
