...
//$sql .= " and faq_acc_type='1'";
 if ($faq_s_id!='') 		{$sql .= " and faq_s_id='$faq_s_id' "; }
if ($faq_s_id != '') {
                    ...
                    <form method="get" name="form2" id="form2" onSubmit="return confirm_submit(this)">
                      <table class="table table-bordered">
                        <tr>
                          ...
                          <td class="tdLabel" align="right" nowrap="nowrap">Services Cate :</td>
                          <td><?php
                          ...
                          <td><input name="faq_question" type="text" class="form-control" value="<?= htmlspecialchars($faq_question) ?>"></td>
                          <td align="right">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 ">
                          <div class="grid-container lh-25">
                            <a class="btn btn-primary float-right" href="faq_f.php?faq_s_id=<?=$faq_s_id?>">Add Faq</a>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <form method="post" name="form1" id="form1" onSubmit="confirm_submit(this)">
                        ...
                        <table class="table table-bordered mb-0">
                          <thead class="table-light">
                            <tr>
                              <th width="8%" nowrap="nowrap"># <?= sort_arrows('faq_id') ?></th>
                          ...
                          <tbody>
                            ...
                            <td><?=$service_title?></td>
                            <td nowrap="nowrap" title="<?= $faq_question ?>"><?=str_stop($faq_question, 25)?> <? //= $faq_question ?> </td>
                            <td nowrap="nowrap" title="<?= $faq_answer ?>"><?=str_stop($faq_answer, 25)?> </td>
                            <td nowrap="nowrap"><? ///= $faq_status?>
                          
                            <?php if ($faq_status == 'Active') { ?>
                                                                        <button type="button" class="btn btn-success btn-sm waves-effect waves-light"><?= $faq_status ?></button>
                                                                    <?php } else if ($faq_status == 'Inactive') { ?>
                                                                        <button type="button" class="btn btn-danger btn-sm waves-effect waves-light"><?= $faq_status ?></button>
                                                                    <?php } ?></td>

                            <td align="center"><a href="faq_f.php?faq_id_en=<?=encryptor('encrypt', $faq_id) ?>"><img src="images/icons/edit.png" alt="Edit" width="16" height="16" border="0" /></a></td>
                          ...
                          <tr>
                            ...
                            <td width="25%" align="right" style="padding:2px">
                             <!-- <input name="Banned2" type="image" src="images/buttons/block_id.gif" onClick="return blockConfirmFromUser('arr_faq_ids[]')" />-->
                              <input name="Activate" type="image" src="images/buttons/activate.gif" onClick="return activateConfirmFromUser('arr_faq_ids[]')" />
                              <input name="Deactivate" type="image" src="images/buttons/deactivate.gif" onClick="return deactivateConfirmFromUser('arr_faq_ids[]')" />
                            </td>
                          </tr>
                        </table>
                      </form>
