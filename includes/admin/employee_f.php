...
if (is_post_back()) {
	...
	if($_FILES['adm_picture']['name']!='') {
		...
		//adm_login = '$adm_login',
		if ($adm_userid != '') {
			$sql = "update ngo_admin set adm_login = '$adm_login', adm_password = '$adm_password', adm_login2 = '$adm_login2', adm_password2 = '$adm_password2',adm_name = '$adm_name', adm_address = '$adm_address', adm_city = '$adm_city', adm_state = '$adm_state', adm_country = '$adm_country', adm_phone = '$adm_phone', adm_email = '$adm_email',adm_gender = '$adm_gender',adm_nationality ='$adm_nationality',adm_marital_status = '$adm_marital_status', adm_dob = '$adm_dob', adm_personal_email = '$adm_personal_email', adm_alt_mobile = '$adm_alt_mobile', adm_curr_address = '$adm_curr_address', adm_father_name = '$adm_father_name', adm_mother_name = '$adm_mother_name', adm_type = 'employee' ,adm_permission='$adm_permission'  $sql_edit_part where adm_userid = $adm_userid";
			db_query($sql);
			$arr_success_msgs[] = "Employee details updated successfully!";
		} else {
			$sql = "insert into ngo_admin set adm_login = '$adm_login', adm_password = '$adm_password', adm_login2 = '$adm_login2' , adm_password2 = '$adm_password2', adm_name = '$adm_name', adm_address = '$adm_address', adm_city = '$adm_city', adm_state = '$adm_state', adm_country = '$adm_country', adm_phone = '$adm_phone', adm_email = '$adm_email', adm_gender = '$adm_gender',adm_nationality ='$adm_nationality',adm_marital_status = '$adm_marital_status', adm_dob = '$adm_dob', adm_personal_email = '$adm_personal_email', adm_alt_mobile = '$adm_alt_mobile', adm_curr_address = '$adm_curr_address', adm_father_name = '$adm_father_name', adm_mother_name = '$adm_mother_name',adm_status = 'Active', adm_type = 'employee',adm_date=ADDDATE(now(),INTERVAL 750 MINUTE),adm_permission='$adm_permission' ";
			db_query($sql);
			$arr_success_msgs[] = "Employee details created successfully!";
		}
...
<body>
										...
										<form name="form1" method="post" enctype="multipart/form-data" <?= validate_form() ?>>
											...
											<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tableForm">
												...
												<!-- <tr>
													...
													<td width="806" class="tdData"><input name="adm_city" type="text" id="adm_city" value="<?= $adm_city ?>" class="form-control"></td>
												</tr> -->


												<!-- <tr>
													<td width="18%" align="right" class="tdLabel">State :</td>
													<td width="806" class="tdData"><input name="adm_state" type="text" id="adm_state" value="<?= $adm_state ?>" class="form-control"></td>
												</tr> -->

												<!-- <tr>
													<td width="18%" align="right" class="tdLabel">Country :</td>
													<td width="806" class="tdData"><input name="adm_country" type="text" id="adm_country" value="<?= $adm_country ?>" class="form-control"></td>
												</tr> -->
   ...
   <tr>
	 ...
	 <td width="270" class="tdData"><img src="<? //=UP_FILES_WS_PATH.'/'.$adm_picture
												?>" width="150" /><br>Delete<input type="checkbox" name="adm_picture_del" value="1"></td>
   </tr>		 
   <? //}
	?>-->
												<!--<tr>
	 ...
	 <td width="270" class="tdData"><input name="adm_picture" type="file" id="adm_picture" ></td>
												...
												<tr>
													<td width="141" class="tdLabel" align="right">Admin Permission :</td>
													<td width="270" class="tdData"><br>
														<?
														// print_r($ARR_ADMIN_LINK_PERMISSION);
														echo make_checkboxes($ARR_ADMIN_LINK_PERMISSION, 'permission_check', $permission_check, 5,	$missit, $style	= 'nor_content', $tableattr = 'align="left" width="100%", border="0"', 'other') ?> </td>
												</tr>
