...
*/
 if (is_post_back()) {
  ...
  $arr_success_msgs = array();
   ...
   $query = "select adm_password from ngo_admin where adm_password = '$oldpassword' and adm_userid= '$_SESSION[sess_admin_userid]'";
  ...
  if (count($arr_error_msgs) == 0) {
    ...
    $query_update = "update ngo_admin set adm_password = '$newpassword' where adm_password = '$oldpassword' and adm_userid= '$_SESSION[sess_admin_userid]'";
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="page-title mb-0">
                                   Change Password  <?php /// echo ($adm_userid == '') ? "Change Password" : "Change Password"; ?>
                                </h4>
                            </div>
                            <div class="col-lg-6">
