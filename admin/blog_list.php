                                        ...
                                        <form method="get" name="form2" id="form2"
                                            ...
                                            <table class="table table-bordered">
                                                <tr>
                                                    ...
                                                    <td><input name="blog_name" class="form-control" type="text"
                                                            value="<?= !empty($_GET['blog_name']) ? htmlspecialchars($_GET['blog_name']) : '' ?>" />
                                                    </td>

                                                    <td class="tdLabel" align="right" nowrap="nowrap">Status :</td>
                                                    <td class="tdLabel" align="right" nowrap="nowrap">
                                                        <?= service_status_dropdown('blog_status', isset($_GET['blog_status']) ? $_GET['blog_status'] : '') ?>
                                                    </td>
                                                    <td align="right">
                                                    ...
                                                    <input type="hidden" name="blog_id"
                                                        value="<?= htmlspecialchars($blog_id) ?>" />
                                                </tr>
                                            </table>
                                        </form>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 ">
                                                    <div class="grid-container lh-25">
                                                        <a class="btn btn-primary float-right" href="blog_f.php">Add
                                                            Blog</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <form method="post" name="form1" id="form1" onSubmit="confirm_submit(this)">
                                                ...
                                                <table width="100%" border="0" cellpadding="0" cellspacing="1"
                                                    ...
                                                    <thead class="table-light">
                                                        <tr>
                                                            <th width="8%" nowrap="nowrap"># <?= sort_arrows('blog_id') ?>
                                                            </th>
                                                        ...
                                                        <tr class="<?= $css ?>">
                                                            ...
                                                            <td width="6%" nowrap="nowrap">
                                                                <?php if ($blog_type == 'image') { ?>
                                                                    <img src="<?= show_thumb(UP_FILES_WS_PATH . '/photo/' . $image, 75, 75, 'height') ?>"
                                                                        align="center" border="0" class="txtbox" />
                                                                <?php } else { ?>
                                                                    <video width="75" height="75" controls>
                                                                        <source src="<?= UP_FILES_WS_PATH . '/video/' . $video ?>"
                                                                            type="video/mp4">
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if ($blog_status == 'active') { ?>
                                                                    <button type="button"
                                                                        class="btn btn-success btn-sm waves-effect waves-light"><?= $blog_status ?></button>
                                                                <?php } else if ($blog_status == 'inactive') { ?>
                                                                    <button type="button"
                                                                        class="btn btn-danger btn-sm waves-effect waves-light"><?= $blog_status ?></button>
                                                                <?php } ?>

                                                            </td>

                                                            <td align="center" nowrap="nowrap"><a
                                                                    href="blog_f.php?blog_id=<?= $blog_id ?>"><img
                                                            ...
                                                            <td align="center"><input name="arr_blog_ids[]" type="checkbox"
                                                                    id="arr_blog_ids[]" value="<?= $blog_id ?>" /></td>
                                                        </tr>
                                                    <? }
                                                    ?>
                                                </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="25%" align="right" style="padding:2px">
                                                            ...
                                                            <input name="Activate" type="image"
                                                                ...
                                                                onClick="return activateConfirmFromUser('arr_blog_ids[]')" />
                                                            <input name="Deactivate" type="image"
                                                                src="images/buttons/deactivate.gif"
                                                                onClick="return deactivateConfirmFromUser('arr_blog_ids[]')" />
                                                            <input name="Delete" type="image" id="Delete"
                                                                src="images/buttons/delete.gif"
                                                                onclick="return deleteConfirmFromUser('arr_blog_ids[]')" />
                                                        </td>
