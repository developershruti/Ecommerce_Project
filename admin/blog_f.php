                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <div class="p-2">
                                                                                    ...
                                                                                    <div class="mb-2 row">
                                                                                        <label
                                                                                            ...
                                                                                            for="simpleinput">Name <span
                                                                                                class="text-danger text-lg">*</span></label>
                                                                                        <div class="col-md-10">
                                                                                            <input type="text"
                                                                                                id="simpleinput"
                                                                                                class="form-control"
                                                                                    ...
                                                                                    <div class="col-md-10">
                                                                                        <select name="blog_type"
                                                                                            ...
                                                                                            <option value="">Select
                                                                                                Option</option>
                                                                                            <option value="image"
                                                                                                <?= ($blog_type == 'image') ? 'selected' : '' ?>>
                                                                                                Image</option>
                                                                                            <option value="video"
                                                                                                <?= ($blog_type == 'video') ? 'selected' : '' ?>>
                                                                                                Video</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>

                                                                                <div id="image_upload" class="mb-2 row"
                                                                                    style="display: <?= ($blog_type == 'image') ? 'flex' : 'none' ?>">
                                                                                    <label
                                                                                        class="col-md-2 col-form-label"
                                                                                        for="image">Image Upload <span
                                                                                            class="text-danger text-lg">*</span></label>
                                                                                    <div class="col-md-10">
                                                                                        <input type="file"
                                                                                            class="form-control"
                                                                                        ...
                                                                                        <?php if (!empty($image)) { ?>
                                                                                        <div class="mt-2">
                                                                                            <img src="<?= UP_FILES_WS_PATH . '/photo/' . $image ?>"
                                                                                                width="98"
                                                                                ...
                                                                                <div id="video_upload" class="mb-2 row"
                                                                                    style="display: <?= ($blog_type == 'video') ? 'flex' : 'none' ?>">
                                                                                    <label
                                                                                        class="col-md-2 col-form-label"
                                                                                        for="video">Video Upload <span
                                                                                            class="text-danger text-lg">*</span></label>
                                                                                    <div class="col-md-10">
                                                                                        <input type="file"
                                                                                            class="form-control"
                                                                                        ...
                                                                                        <div class="mt-2">
                                                                                            <video width="150" controls>
                                                                                                <source
                                                                                                    src="<?= UP_FILES_WS_PATH . '/video/' . $video ?>"
                                                                                                    type="video/mp4">
                                                                                ...
                                                                                <div class="mb-2 row">
                                                                                    <label
                                                                                        class="col-md-2 col-form-label">Short
                                                                                        Description:</label>
                                                                                    <div class="col-md-5">
                                                                                        <textarea id="blog_shortdesc"
                                                                                            name="blog_shortdesc"
                                                                                            alt="blank"
                                                                                            emsg="Enter short description"
                                                                                            placeholder="Enter short Description"><?= $blog_shortdesc ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="mb-2 row">
                                                                                    ...
                                                                                    <div class="col-md-10">
                                                                                        <textarea id="blog_desc"
                                                                                            class="summernote"
                                                                                            name="blog_desc" alt="blank"
                                                                                            emsg="Enter long description"
                                                                                            placeholder="Enter long Description"><?= $blog_desc ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="mb-2 row">
                                                                                    ...
                                                                                    <div class="col-md-10">
                                                                                        ...
                                                                                        <input name="old_image"
                                                                                            type="hidden" class="txtbox"
                                                                                            id="old_image"
                                                                                            value="<?= $image ?>" />
                                                                                        <input name="old_video"
                                                                                            type="hidden" class="txtbox"
                                                                                            id="old_video"
                                                                                            value="<?= $video ?>" />
                                                                                        <button type="submit"
