...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="content">
      ...
      <br />
            <div align="right"> <a href="product_pic_f.php">Add New Products  </a></div>
      ...
      <form method="post" name="form1" id="form1" onsubmit="confirm_submit(this)">
        <table width="100%"  border="0" cellpadding="0" cellspacing="1" class="tableList">
          <tr>
               <th width="17%" align="center" nowrap="nowrap">Product Id <?= sort_arrows('pic_id')?></th>
			  
               <th width="16%" align="center" nowrap="nowrap">Product</th>
               <th width="57%" align="center" nowrap="nowrap">Product Name                 <?= sort_arrows('pic_name ')?></th>
          ...
          <tr class="<?=$css?>">
                       ...
                       <!-- <td nowrap="nowrap"><?#=$pic_desc?></td>-->
						 <td nowrap="nowrap"><?=$pic_status?></td>
                                    <td align="center"><a href="product_pic_f.php?pic_id=<?=$pic_id?>"><img src="images/icons/edit.png" alt="Edit" width="16" height="16" border="0" /></a></td>   
