...
<form name="form1" method="post" enctype="multipart/form-data" <?= validate_form()?>>
  <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tableForm">
	  <tr>
      <td width="346" align="left" class="tdLabel">Panel Name:</td>
      <td width="920" class="tdData"> 
	  <? //=panel_dropdown('gallery_type',$gallery_type,$extra)?>
      ...
      <td width="920" class="tdData"><input name="gallery_name" type="text" id="gallery_name" value="<?=$gallery_name?>"  alt="blank" class="textfield"></td>
	   ...
	   <tr>
      <td width="346" align="left" class="tdLabel">   URL :</td>
      <td width="920" class="tdData"><input name="gallery_url" type="text" id="gallery_url" value="<?=$gallery_url?>"  alt="blank" emsg="Please Enter Vedio Id" class="textfield"></td>
      </tr>
        <tr>
		 <? if($gallery_image!='') { ?>
          <tr>
