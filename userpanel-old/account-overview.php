                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-striped table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="<?=SITE_BACKEND_BASE_URL?>/images/users/avatar-4.jpg" alt="table-user"
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="<?=SITE_BACKEND_BASE_URL?>/images/users/avatar-3.jpg" alt="table-user"
                                                            class="mr-2 avatar-xs rounded-circle">
                                                        <a href="javascript:void(0);"
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="<?=SITE_BACKEND_BASE_URL?>/images/users/avatar-8.jpg" alt="table-user"
                                                            class="mr-2 avatar-xs rounded-circle">
                                                        <a href="javascript:void(0);"
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="<?=SITE_BACKEND_BASE_URL?>/images/users/avatar-1.jpg" alt="table-user"
                                                            class="mr-2 avatar-xs rounded-circle">
                                                        <a href="javascript:void(0);"
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="<?=SITE_BACKEND_BASE_URL?>/images/users/avatar-5.jpg" alt="table-user"
                                                            class="mr-2 avatar-xs rounded-circle">
                                                        <a href="javascript:void(0);"
